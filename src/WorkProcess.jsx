            ...
            <div className="grid ml-6 md:grid-cols-2 my-4">
              <div className="grid text-left gap-4 lg:ml-10 mb-5">
                ...
                <div className="p-3 rounded shadow-md w-64 bg-gray-900">
                  ...
                  <p className="text-sm mt-3 text-justify">
                    ...
                    related apps. Sometime use the given figma file or readymade
                    templet. Which gives an idea about work and app design.{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="grid text-left gap-4 lg:mt-5">
                ...
                <div className="p-3 rounded shadow-md w-64 bg-gray-900">
                  ...
                  <p className="text-sm mt-3 text-justify">
                    When analyzeing done, the development work go in full swing
                    with MoSCoW Prioritization and finally the main product
                    launch.{" "}
                  </p>
                </div>
              </div>
