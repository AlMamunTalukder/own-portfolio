  ...
  return (
    <footer className="footer items-center text-center p-4 bg-white bg-opacity-10  shadow-lg rounded-md lg:items-center lg:text-center">
      ...
      <img
        ...
        className="w-8 rounded lg:w-10 place-self-center lg:place-self-start"
      />

      <aside className="text-center grid-flow-col ml-4 md:ml-4">
        <p className="lg:ml-32">
          Al Mamun Talukder © 2023 - All right reserved
        </p>
      </aside>
      {/* </div> */}
      <nav className="grid-flow-col gap-4 place-self-center md:place-self-center md:justify-self-end">
        ...
        {/* facebook */}
        <a href="https://www.facebook.com/amtsokal">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        {/* linkedin */}
        <a href="https://www.linkedin.com/in/amtalukder/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        {/* github */}
        <a href="https://github.com/AlMamunTalukder">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 24 24"
